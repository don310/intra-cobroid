...
import { FaBook, FaChalkboardTeacher, FaBlog } from 'react-icons/fa';
import {
  FaCode,
  FaFacebookF,
  FaTwitter,
...
<p className="text-lg text-gray-600 mb-6">
  Explore a variety of learning materials 📝, tutorials 🎓, and blogs 💡 to enhance your educational journey.
</p>
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
  
  {/* Notes */}
  <div className="bg-blue-100 p-6 shadow-lg rounded-lg">
    <FaBook className="mx-auto mb-4 text-gray-800" size={60} />
    <h4 className="font-bold text-xl mb-2">Notes</h4>
    <p className="text-gray-600 mb-4">
      Access comprehensive notes that simplify complex ideas into easily understandable content.
    </p>
    <Link href="/notes" className="text-blue-500 hover:text-blue-700 flex items-center">
      Learn More <AiOutlineArrowRight className="ml-2" />
    </Link>
  </div>
  
  {/* Tutorials */}
  <div className="bg-yellow-100 p-6 shadow-lg rounded-lg">
    <FaChalkboardTeacher className="mx-auto mb-4 text-gray-800" size={60} />
    <h4 className="font-bold text-xl mb-2">Tutorials</h4>
    <p className="text-gray-600 mb-4">
      Explore a wide range of tutorials that break down complicated concepts into easy-to-follow lessons.
    </p>
    <Link href="/tutorials" className="text-blue-500 hover:text-blue-700 flex items-center">
      Learn More <AiOutlineArrowRight className="ml-2" />
    </Link>
  </div>
  ...
  <div className="bg-green-100 p-6 shadow-lg rounded-lg">
    <FaBlog className="mx-auto mb-4 text-gray-800" size={60} />
    <h4 className="font-bold text-xl mb-2">Blogs</h4>
    <p className="text-gray-600 mb-4">
      Stay up to date with the latest insights, trends, and expert advice in our blog section.
    </p>
    <Link href="/blogs" className="text-blue-500 hover:text-blue-700 flex items-center">
      Learn More <AiOutlineArrowRight className="ml-2" />
    </Link>
  </div>
</div>
...
<button
  onClick={() =>
    window.location.href = "https://chat.whatsapp.com/LGYhok8hVed1EvY2vOwtUk"
  }
  className="bg-white text-primary px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition duration-300"
>
  Get Started
</button>
</section>
