...
const tutorialContent = [
  ...
  My name is Harry (the same Intra Cobroid Academy guy from YouTube), and today I'm writing this comprehensive HTML tutorial for all of you. Let's jump right into HTML!
  ...
  **In the next tutorial, we'll continue our journey and understand how websites work!**
    ...
    {
      path: '/tutorials/html-home/working',
    }
  ];
      ...
      <div className="flex-1 ml-64">
        ...
        <div className="pt-40 p-8 max-w-full">
          <div className="bg-white shadow-md rounded-lg p-6 border border-gray-300">
            <h1 className="text-3xl font-bold mb-4">{tutorial ? tutorial.title : "HTML Tutorial"}</h1>
